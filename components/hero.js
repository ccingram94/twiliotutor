        ...
        <div className="container mx-auto items-center flex flex-wrap w-full">
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32">
              ...
              <div className="flex flex-row flex-wrap justify-start font-semibold px-12 py-2 max-w-full">
                <div className=" flex flex-row bg-blue-100 rounded-xl space-x-2 px-2 py-2">
                  <AuthButton />
                  <ClassroomButton />
                </div>
              </div>
